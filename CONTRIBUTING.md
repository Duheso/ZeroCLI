# Contributing to Zero CLI

Thanks for contributing.

Zero CLI is a fast-moving open-source coding-agent CLI with support for multiple providers, local backends, MCP, and a terminal-first workflow. The best contributions here are focused, well-tested, and easy to review.

## Before You Start

- Search existing [issues](https://github.com/Duheso/ZeroCLI/issues) and [discussions](https://github.com/Duheso/ZeroCLI/discussions) before opening a new thread.
...
Zero CLI supports multiple provider paths. If you change provider logic:
