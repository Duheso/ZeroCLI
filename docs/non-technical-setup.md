# Zero CLI for Non-Technical Users
...
Zero CLI lets you use an AI coding assistant with different model providers such as:
...
After you run `zero`, the CLI should start and wait for your prompt.
