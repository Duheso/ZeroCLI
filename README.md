...
[![PR Checks](https://github.com/Duheso/ZeroCLI/actions/workflows/pr-checks.yml/badge.svg?branch=main)](https://github.com/Duheso/ZeroCLI/actions/workflows/pr-checks.yml)
[![Release](https://img.shields.io/github/v/tag/Gitlawb/zero?label=release&color=0ea5e9)](https://github.com/Duheso/ZeroCLI/tags)
[![Discussions](https://img.shields.io/badge/discussions-open-7c3aed)](https://github.com/Duheso/ZeroCLI/discussions)
...
The repo includes a VS Code extension in [`vscode-extension/zero-vscode`](vscode-extension/zero-vscode) for Zero CLI launch integration, provider-aware control-center UI, and theme support.
...
- Use [GitHub Discussions](https://github.com/Duheso/ZeroCLI/discussions) for Q&A, ideas, and community conversation
- Use [GitHub Issues](https://github.com/Duheso/ZeroCLI/issues) for confirmed bugs and actionable feature work
...
Zero CLI originated from the Claude Code codebase and has since been substantially modified to support multiple providers and open use. "Claude" and "Claude Code" are trademarks of Anthropic PBC. See [LICENSE](LICENSE) for details.
