...
const PROTO_PATH = path.resolve(import.meta.dirname, '../src/proto/zero.proto')
...
const zeroProto = protoDescriptor.zero.v1
...
async function main() {
  ...
  const client = new zeroProto.AgentService(
    `${host}:${port}`,
  ...
  console.log('\x1b[32mZero CLI gRPC CLI\x1b[0m')
