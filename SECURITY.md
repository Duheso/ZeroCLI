...
ZeroCLI is currently maintained on the latest `main` branch and the latest
npm release only.
...
If you believe you have found a security vulnerability in ZeroCLI, please
report it privately.
...
- the ZeroCLI source code in this repository
- official release artifacts published from this repository
- the `@duheso/zerocli` npm package
