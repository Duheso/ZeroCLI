...
export function CheckExistingSecretStep(t0: { useExistingSecret: boolean; secretName: string; onToggleUseExistingSecret: (useExisting: boolean) => void; onSecretNameChange: (value: string) => void; onSubmit: () => void }) {
  const $ = _c(42);
  const {
    useExistingSecret,
    secretName,
