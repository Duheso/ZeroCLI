/**
 * MDM (Mobile Device Management) profile enforcement for ZeroCLI managed settings.
 *
 ...
 * - Windows: `HKLM\SOFTWARE\Policies\ZeroCode` (admin-only)
 *   and `HKCU\SOFTWARE\Policies\ZeroCode` (user-writable, lowest priority)
