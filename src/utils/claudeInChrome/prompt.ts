export const BASE_CHROME_PROMPT = `# Zero in Chrome browser automation
...
2. Then: Call mcp__zero-in-chrome__tabs_context_mcp`
...
/**
 * Minimal hint about Zero in Chrome skill availability. This is injected at startup when the extension is installed
 ...
 */
export const CLAUDE_IN_CHROME_SKILL_HINT_WITH_WEBBROWSER = `**Browser Automation**: Use WebBrowser for development (dev servers, JS eval, console, screenshots). Use zero-in-chrome for the user's real Chrome when you need logged-in sessions, OAuth, or computer-use — invoke Skill(skill: "zero-in-chrome") before any mcp__zero-in-chrome__* tool.`
