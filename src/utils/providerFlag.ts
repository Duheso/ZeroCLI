 ...
 *   zero --provider gemini --model gemini-2.0-flash
 *   zero --provider mistral --model ministral-3b-latest
 *   zero --provider ollama --model llama3.2
 *   zero --provider anthropic   (default, no-op)
 */
