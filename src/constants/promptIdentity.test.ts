...
test('CLI identity prefixes describe Zero CLI instead of Claude Code', () => {
...
test('simple mode identity describes Zero CLI instead of Claude Code', async () => {
...
test('built-in agent prompts describe Zero CLI instead of Claude Code', () => {
