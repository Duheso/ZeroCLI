 ...
 *
 * This instruction provides guidance for Zero's behavior when handling
 ...
 *   - How Zero handles penetration testing and CTF requests
 *   - What security tools and techniques Zero will assist with
 ...
 *
 * Zero: Do not edit this file unless explicitly asked to do so by the user.
 */
