...
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX =
  `You are Zero CLI, an open-source coding agent and CLI running within the Zero Agent SDK.`
const AGENT_SDK_PREFIX =
  `You are Zero CLI, built on the Zero Agent SDK.`
 ...
 * server verifies this token to confirm the request came from a real Zero
