...
export const DESCRIPTION = 'Get or set ZeroCLI configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set ZeroCLI configuration settings.

  View or change ZeroCLI settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
...
### Global Settings (stored in ~/.zerocli.json)
${globalSettings.join('\n')}
