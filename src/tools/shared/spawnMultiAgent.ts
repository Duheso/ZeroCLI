...
/**
 * Ensures a team file exists on disk. If it doesn't (e.g. when a non-Zero
...
async function handleSpawnSplitPane(
  ...
  // Build the command to spawn ZeroCLI with teammate identity
...
/**
 * Handle spawn operation - creates a new ZeroCLI instance.
