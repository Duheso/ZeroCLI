...
export function TranscriptSharePrompt(t0: Props) {
  const $ = _c(11);
  const {
    onSelect,
    inputValue,
  ...
  if ($[6] === Symbol.for("react.memo_cache_sentinel")) {
    t3 = <Box><Text color="ansi:cyan">{BLACK_CIRCLE} </Text><Text bold={true}>Can Anthropic look at your session transcript to help us improve ZeroCLI?</Text></Box>;
    $[6] = t3;
  } else {
    t3 = $[6];
  }
