...
export function LogoV2() {
  ...
  const borderTitle = ` ${color("text", userTheme)("ZeroCLI")} ${color("inactive", userTheme)(`v${version}`)} `;
  const compactBorderTitle = color("text", userTheme)(" ZeroCLI ");
