 ...
 * users think of as "a new message from Zero" — not raw assistant entries
 ...
 * until Zero's text response lands.
 */
...
// conversation turn's prompt above the viewport so you know what Zero was
