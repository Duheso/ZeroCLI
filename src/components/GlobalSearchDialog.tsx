...
function _temp4(query_0: string, controller_1: AbortController, setMatches_0: (m: (prev: Match[]) => Match[]) => void, setTruncated_0: (m: boolean | ((prev: boolean) => boolean)) => void, setIsSearching_0: (m: boolean | ((prev: boolean) => boolean)) => void) {
  const cwd = getCwd();
  let collected = 0;
