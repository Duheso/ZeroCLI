...
const WORKFLOWS: WorkflowOption[] = [{
  ...
  label: '@ZeroCLI - Tag @claude in issues and PR comments'
}, {
  value: 'claude-review' as const,
  label: 'ZeroCLI Review - Automated code review on new PRs'
}];
...
export function WorkflowMultiselectDialog(t0: Props) {
  const $ = _c(14);
  const {
    onSubmit,
    defaultSelections
...
function _temp(workflow: { label: string; value: Workflow }) {
  return {
