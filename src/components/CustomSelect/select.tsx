...
export function Select(t0: SelectProps<unknown>) {
  const $ = _c(72);
  const {
    isDisabled: t1,
    hideIndexes: t2,
...
function _temp9(c_3: any) {
  return c_3.type === "image";
}
function _temp8(opt_0: any) {
  return opt_0.description;
}
function _temp7(opt: any) {
  return opt.type === "input";
}
function _temp6(c_2: any) {
  return c_2.type === "image";
}
function _temp5(c_1: any) {
