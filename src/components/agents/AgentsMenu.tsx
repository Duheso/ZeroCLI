    ...
    case "list-agents":
      {
        ...
        if ($[34] !== changes || $[35] !== onExit) {
          t15 = () => {
            ...
            onExit(exitMessage ?? t('cmd_agents_dismissed') as string, {
    ...
    case "agent-menu":
      {
        ...
        if ($[61] !== isEditable) {
          t15 = isEditable ? [{
            label: t('agents_menu_edit'),
            value: "edit"
          }, {
            label: t('agents_menu_delete'),
            value: "delete"
          }] : [];
          $[61] = isEditable;
          $[62] = t15;
    ...
    case "view-agent":
      {
        ...
        if ($[109] === Symbol.for("react.memo_cache_sentinel")) {
          t18 = <AgentNavigationFooter instructions={t('agents_nav_enter_esc')} />;
          $[109] = t18;
        } else {
          t18 = $[109];
        }
    ...
    case "delete-confirm":
      {
        ...
        if ($[112] === Symbol.for("react.memo_cache_sentinel")) {
          t13 = [{
            label: t('agents_confirm_yes'),
            value: "yes"
          }, {
            label: t('agents_confirm_no'),
            value: "no"
          }];
          $[112] = t13;
        } else {
        ...
        if ($[115] !== modeState.agent.agentType) {
          t15 = <Text>{t('agents_confirm_delete_prefix')}{" "}<Text bold={true}>{modeState.agent.agentType}</Text>?</Text>;
        ...
        if ($[117] !== modeState.agent.source) {
          t16 = <Box marginTop={1}><Text dimColor={true}>{t('agents_detail_source')(modeState.agent.source)}</Text></Box>;
        ...
        if ($[127] !== t14 || $[128] !== t15 || $[129] !== t16 || $[130] !== t19) {
          t20 = <Dialog title={t('agents_confirm_delete_title')} onCancel={t14} color="error">{t15}{t16}{t19}</Dialog>;
          $[127] = t14;
          $[128] = t15;
          $[129] = t16;
          $[130] = t19;
        ...
        if ($[132] === Symbol.for("react.memo_cache_sentinel")) {
          t21 = <AgentNavigationFooter instructions={t('agents_nav_navigate_cancel')} />;
          $[132] = t21;
        } else {
          t21 = $[132];
        }
    ...
    case "edit-agent":
      {
        ...
        const t14 = t('agents_edit_title')(agentToEdit.agentType);
        let t15;
...
function _temp3(s_1: import('../../state/AppState.js').AppState) {
  return s_1.toolPermissionContext;
}
function _temp2(s_0: import('../../state/AppState.js').AppState) {
