...
/**
 * Map LSP severity to Zero diagnostic severity
 *
 * Maps LSP severity numbers to Zero diagnostic severity strings.
...
/**
 * Convert LSP diagnostics to Zero diagnostic format
 *
 * Converts LSP PublishDiagnosticsParams to DiagnosticFile[] format
 * used by Zero's attachment system.
 */
 ...
 * from all LSP servers and routes them to Zero's diagnostic system.
      ...
      serverInstance.onNotification(
        ...
        (params: unknown) => {
          ...
          try {
            ...
            // Convert LSP diagnostics to Zero format (can throw on invalid URIs)
