...
/**
 * Fetch the user's first ZeroCLI token date and store in config.
 * This is called after successful login to cache when they started using ZeroCLI.
 */
export async function fetchAndStoreZeroCodeFirstTokenDate(): Promise<void> {
  try {
