...
<html lang="en">
  ...
  <body>
    ...
    <p>You can return to Zero CLI now.</p>
    <p>Zero CLI will finish activating your new Codex OAuth login.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>${safeMessage}</p>
    <p>You can close this window and try again in Zero CLI.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>You can close this window and retry in Zero CLI.</p>
  </body>
</html>`
}
