...
// OAuth credentials as ZeroCLI.  The endpoint uses conversation_engine
...
export function isVoiceStreamAvailable(): boolean {
  // voice_stream uses the same OAuth as ZeroCLI — available when the
  // user is authenticated with Anthropic (Zero.ai subscriber or has
  // valid OAuth tokens).
