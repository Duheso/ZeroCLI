...
/**
 * Loads markdown files from .zerocli/output-styles directories throughout the project
 * and from ~/.zerocli/output-styles directory and converts them to output styles.
 *
 ...
 *
 * Structure:
 * - Project .zerocli/output-styles/*.md -> project styles
 * - User ~/.zerocli/output-styles/*.md -> user styles (overridden by project styles)
 *
