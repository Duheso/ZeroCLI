...
Help the user debug an issue they're encountering in this current ZeroCLI session.
${justEnabledSection}
## Session Debug Log
...
3. Consider launching the ${CLAUDE_CODE_GUIDE_AGENT_TYPE} subagent to understand the relevant ZeroCLI features
